...
export const conteudoEn: Conteudo = {
  ...
  produto: {
    ...
    medicao: {
      ...
      texto:
        'Part of the subscribers with failed charges stays out of CRAI’s action and gets only the mandatory retries. The rest gets the action. Every month, the recovery gap between the two groups is computed and shown in the dashboard.',
      legenda: 'CRAI’s bill is the area between the two lines.',
      grafico: {
        titulo: 'Recovery rate of the control group and the treated group over 12 months',
        descricao: 'The two lines start close and drift apart over the months. The area between them is the incremental gain.',
  ...
  cadastro: {
    ...
    lead: 'The fields come pre-filled with a demo company. Review if you like and move on.',
    ...
    responsavel: {
      ...
      telefone: 'Phone',
      senha: 'Password',
      senhaDica: 'Demo password. Nothing is saved.',
    },
    operacao: {
      titulo: 'Operation',
      plano: 'Plan',
  ...
  pagamento: {
    ...
    lead: 'The success fee is charged through Pix Automático, only on measured results. The fields come pre-filled.',
